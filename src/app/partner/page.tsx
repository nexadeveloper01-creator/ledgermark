...
const D: Dict = {
  ...
  tabQueue: { ko: "소유권 이전 큐", en: "Transfer queue", fil: "Transfer queue" },
  tabCheckout: { ko: "매장 결제", en: "Checkout", fil: "Bayad sa tindahan" },
  tabStaff: { ko: "직원 관리", en: "Staff", fil: "Mga tauhan" },
  tabExchanges: { ko: "하자·교환", en: "Defects & exchanges", fil: "Depekto at palitan" },
  ...
  orgFallback: { ko: "소속 기관", en: "Your organization", fil: "Iyong organisasyon" },
  queueTitle: { ko: "소유권 이전 대기 큐", en: "Transfer queue", fil: "Pila ng paglipat ng pagmamay-ari" },
  thRequest: { ko: "요청", en: "Request", fil: "Kahilingan" },
  thApplicant: { ko: "신청자", en: "Requester", fil: "Humihiling" },
  thStatus: { ko: "상태", en: "Status", fil: "Status" },
  noRequests: { ko: "대기 중인 요청이 없습니다.", en: "No pending requests.", fil: "Walang naghihintay na kahilingan." },
  blocked: { ko: "판매 차단", en: "Sale blocked", fil: "Naka-block ang benta" },
  jProduct: { ko: "제품", en: "Product", fil: "Produkto" },
  jCurStatus: { ko: "현재 상태", en: "Current status", fil: "Kasalukuyang status" },
  jPrevOwner: { ko: "이전 소유자", en: "Previous owner", fil: "Dating may-ari" },
  jNewOwner: { ko: "신규 소유자", en: "New owner", fil: "Bagong may-ari" },
  jAge: { ko: "연령인증", en: "Age check", fil: "Age check" },
  ageDone: { ko: "앱 인증 완료", en: "Verified in app", fil: "Na-verify sa app" },
  ageNone: { ko: "미완료", en: "Not verified", fil: "Hindi pa na-verify" },
  jVoucher: { ko: "교환권", en: "Voucher", fil: "Voucher" },
  voucherSpend: { ko: "소진 예정", en: "will be spent", fil: "gagamitin" },
  commit: { ko: "커밋", en: "Commit", fil: "I-commit" },
  hold: { ko: "보류", en: "Hold", fil: "I-hold" },
  blockedNote: { ko: "관제 콘솔로 밀수 의심 알림이 전송되었습니다.", en: "A smuggling alert was escalated to the console.", fil: "Ipinadala sa console ang alerto ng posibleng smuggling." },
  msgCommitted: { ko: "원장에 소유권 이전 트랜잭션이 기록되었습니다.", en: "Ownership transfer recorded on the ledger.", fil: "Naitala sa ledger ang paglipat ng pagmamay-ari." },
  msgRejected: { ko: "요청을 반려했습니다.", en: "Request rejected.", fil: "Tinanggihan ang kahilingan." },
  ptype_RETAIL_SALE: { ko: "소매 판매 처리", en: "Retail sale", fil: "Retail sale" },
  ptype_EXCHANGE_TRANSFER: { ko: "불량 교환 처리", en: "Defect exchange", fil: "Palitan sa depekto" },
  ptype_WHOLESALE_TRANSFER: { ko: "총판 배분", en: "Wholesale allocation", fil: "Wholesale allocation" },
  pcta_RETAIL_SALE: { ko: "소유권 이전 / COMMIT", en: "Commit transfer", fil: "I-commit ang paglipat" },
  pcta_EXCHANGE_TRANSFER: { ko: "교환 승인 / COMMIT", en: "Approve exchange", fil: "Aprubahan ang palitan" },
  pcta_WHOLESALE_TRANSFER: { ko: "일괄 이전 / COMMIT", en: "Commit batch", fil: "I-commit ang batch" },
  pnote_RETAIL_SALE: { ko: "커밋 시 RETAIL_SALE 트랜잭션이 원장에 기록되고 다음 앵커링에 포함됩니다.", en: "On commit, a RETAIL_SALE transaction is recorded and included in the next anchor.", fil: "Sa pag-commit, itinatala ang RETAIL_SALE na transaksyon at kasama sa susunod na anchor." },
  pnote_EXCHANGE_TRANSFER: { ko: "기존 교환권은 소진되고 신규 UID는 동일 소유자에게 귀속됩니다.", en: "The existing voucher is spent and a new UID is issued to the same owner.", fil: "Nagagamit ang dating voucher at naglalabas ng bagong UID sa parehong may-ari." },
  pnote_WHOLESALE_TRANSFER: { ko: "LOT 단위 배분도 UID별 소유권 이전 트랜잭션으로 원장에 기록됩니다.", en: "Batch allocation is recorded as per-UID ownership transfers.", fil: "Itinatala ang batch allocation bilang per-UID na paglipat ng pagmamay-ari." },
  pstate_PENDING: { ko: "처리 대기", en: "Pending", fil: "Naghihintay" },
  pstate_COMMITTED: { ko: "이전 완료", en: "Committed", fil: "Nailipat na" },
  pstate_BLOCKED: { ko: "판매 차단", en: "Blocked", fil: "Naka-block" },
  pstate_REJECTED: { ko: "반려됨", en: "Rejected", fil: "Tinanggihan" },
};

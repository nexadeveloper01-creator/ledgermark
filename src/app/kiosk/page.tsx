...
const K: Dict = {
  badge: { ko: "무인 정품 자판기 · SELF-SERVICE", en: "Unmanned authenticity vending · SELF-SERVICE", fil: "Unmanned authenticity vending · SELF-SERVICE" },
  staff: { ko: "직원 모드", en: "Staff mode", fil: "Staff mode" },
  heroT: { ko: "정품 전자담배 자판기", en: "Genuine vape vending machine", fil: "Genuine vape vending machine" },
  heroSub: { ko: "블록체인 원장으로 정품을 확인하고 구매하세요.", en: "Verify authenticity on the blockchain ledger and buy.", fil: "I-verify ang pagka-genuine sa blockchain ledger at bumili." },
  start: { ko: "구매 시작", en: "Start", fil: "Simulan" },
  ageNote: { ko: "만 20세 미만 구매 불가 · 신분 확인이 진행됩니다", en: "No sales under 20 · ID verification required", fil: "Bawal sa wala pang 20 · kailangan ng ID verification" },
  selectT: { ko: "제품 선택", en: "Choose a product", fil: "Pumili ng produkto" },
  soldOutLabel: { ko: "품절 · SOLD OUT", en: "SOLD OUT", fil: "UBOS NA" },
  stockN: { ko: "재고 {n}개", en: "{n} in stock", fil: "{n} natitira" },
  soldOut: { ko: "품절", en: "Sold out", fil: "Ubos na" },
  buy: { ko: "구매", en: "Buy", fil: "Bilhin" },
  noStock: { ko: "현재 판매 가능한 재고가 없습니다.", en: "No stock available right now.", fil: "Walang stock na available ngayon." },
  cancel: { ko: "취소", en: "Cancel", fil: "Kanselahin" },
  verifying: { ko: "정품 확인 중…", en: "Verifying authenticity…", fil: "Sinusuri ang pagka-genuine…" },
  ledgerCheck: { ko: "원장 대조", en: "ledger check", fil: "ledger check" },
  notSellable: { ko: "판매 불가", en: "Not for sale", fil: "Hindi mabibili" },
  toStart: { ko: "처음으로", en: "Start over", fil: "Ulitin" },
  ageT: { ko: "연령 확인", en: "Age check", fil: "Age check" },
  ageAsk: { ko: "만 20세 이상입니까? 신분증을 리더기에 대주세요.", en: "Are you 20 or older? Please tap your ID on the reader.", fil: "20 anyos ka na ba pataas? I-tap ang iyong ID sa reader." },
  ageConfirm: { ko: "성인 인증 완료 (데모)", en: "Adult verified (demo)", fil: "Adult verified (demo)" },
  paying: { ko: "결제 승인 중…", en: "Approving payment…", fil: "Ina-approve ang bayad…" },
  dispensing: { ko: "배출을 준비하고 있습니다", en: "Preparing to dispense", fil: "Inihahanda ang paglabas" },
  dispensed: { ko: "배출 완료", en: "Dispensed", fil: "Nailabas na" },
  claimHint: { ko: "소비자 앱으로 아래 QR을 스캔하면 소유권이 자동 이전되고 300P가 적립됩니다.", en: "Scan the QR below in the consumer app to auto-transfer ownership and earn 300 pts.", fil: "I-scan ang QR sa ibaba gamit ang consumer app para awtomatikong mailipat ang pagmamay-ari at kumita ng 300 pts." },
  qrAlt: { ko: "정품 등록 QR", en: "Registration QR", fil: "Registration QR" },
};
